...
public class ListJobFormHelper extends ItemTouchHelper.SimpleCallback{
    ...
    public ListJobFormHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            //check adapter
            if (this.listener.getClass().getSimpleName().equals("ListJobFormActivity")) {
                backgroundViewEdit = ((ListJobFormAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((ListJobFormAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((ListJobFormAdapter.MyViewHolder) viewHolder).viewForeground;
            }
            //Selected item
